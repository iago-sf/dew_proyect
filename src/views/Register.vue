...
<div class="bg-black h-screen py-[7%]">
    <div class="i-login/register-box">
        ...
        <div>
            ...
            <input aria-labelledby="username" type="username" class="i-login/register-input" v-model.trim="data.username"/>
        </div>
        <div class="mt-6 w-full">
            <label id="email" class="text-sm font-medium leading-none text-red-600">
                Email
            </label>
            <input aria-labelledby="email" type="email" class="i-login/register-input" v-model.trim="data.email"/>
        </div>
        <div class="mt-6 w-full">
            ...
            <div class="relative flex items-center justify-center">
                <input id="pass" type="password" class="i-login/register-input" v-model.trim="data.password"/>
