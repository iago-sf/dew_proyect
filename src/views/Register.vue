...
<div class="bg-black h-screen py-[7%]">
    <div class="i-login/register-box">
        ...
        <div>
            ...
            <input aria-labelledby="username" type="username" class="i-input" v-model.trim="username" maxlength="30"/>
        </div>
        <div class="mt-6 w-full">
            <label id="email" class="text-sm font-medium leading-none text-red-600">
                Email
            </label>
            <input aria-labelledby="email" type="email" class="i-input" v-model.trim="email" maxlength="25"/>
        </div>
        <div class="mt-6 w-full">
            ...
            <div class="relative flex items-center justify-center">
                <input id="pass" type="password" class="i-input" v-model.trim="password" maxlength="20"/>
