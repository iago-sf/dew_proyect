<template>
    <div
        class="text-center border-2 border-red-600 text-red-600 w-1/4 justify-self-center p-16"
    >
        <p
            tabindex="0"
            class="focus:outline-none text-2xl font-extrabold leading-6 text-red-600"
        >
            Login to your account
        </p>
        <p
            tabindex="0"
            class="focus:outline-none text-sm mt-4 font-medium leading-none text-gray-200"
        >
            Dont have account?
            <a href="javascript:void(0)" class="hover:text-gray-200 focus:text-gray-200 focus:outline-none focus:underline hover:underline text-sm font-medium leading-none text-red-600 cursor-pointer">
                Sign up here
            </a>
        </p>
        <button
            ...
            role="button"
            class="focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-gray-200 py-3.5 px-4 border rounded-lg border-gray-200 flex items-center w-full mt-10"
        >
        ...
        <div>
            ...
            <input aria-labelledby="email" type="email" class="bg-gray-200 border rounded text-xs font-medium leading-none text-red-600 py-3 w-full pl-3 mt-2"
            />
        </div>
        <div class="mt-6 w-full">
            ...
            <div class="relative flex items-center justify-center">
                <input id="pass" type="password" class="bg-gray-200 border rounded text-xs font-medium leading-none text-red-600 py-3 w-full pl-3 mt-2"/>
